public override string KeyVaultName => "studio-scus-MAML-1";
        ...
        public override Certificate StorageClientCertificate
        {
            get
            {
               return new KeyVaultCertificate("StorageClientCertificate") { SecretName = "studio-prod-scus-storage--storageclientcertificate/3f1db752ee8c41b596d4d8dd34573983", Owner = StudioProdCommonKeyVaultOwner };
            }
        }
        ...
        public override Certificate StorageServiceSSL
        {
            get
            {
               return new KeyVaultCertificate("StorageServiceSSL") { SecretName = "studio-prod-scus-storage--storageservicessl/73fcf7adb7564b3585ff2980f85bc50b", Owner = StudioProdCommonKeyVaultOwner };
            }
        }
        ...
        public override Certificate PIISecondaryCert
        {
            get
            {
               return new KeyVaultCertificate("PIISecondaryCert") { SecretName = "studio-prod-scus-storage--StoragePIIPrimaryCert/827a6a278a4f4c358f3bbf0a56396570", Owner = StudioProdCommonKeyVaultOwner };
            }
        }
        ...
        public override Certificate ServiceConfig
        {
            get
            {
               return new KeyVaultCertificate("ServiceConfig") { SecretName = "studio-prod--serviceconfigcert-ar/69e4548409204adca3bfd305b24f8581", Owner = StudioProdCommonKeyVaultOwner };
            }
        }
